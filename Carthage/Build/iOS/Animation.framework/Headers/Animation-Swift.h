...
- (void)animateRotationTo:(CGFloat)angle clockwise:(BOOL)clockwise duration:(double)duration;
- (void)animateRotateBy:(CGFloat)deltaAngle duration:(double)duration timingFunctionName:(NSString * _Nonnull)timingFunctionName;
@end
